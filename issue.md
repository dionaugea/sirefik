# SIREFIK — Implementation Brief

## What is SIREFIK

SIREFIK (Sistem Informasi Realisasi Fisik dan Keuangan) is a web application for Pemerintah Daerah, starting from Kabupaten Puncak Jaya. It records, verifies, and reports **realisasi fisik dan keuangan** of regional expenditure—especially contracted work packages—so Organisasi Perangkat Daerah (OPD) can replace manual Excel reporting.
